          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <button className="bg-gradient-to-r from-slate-700 to-slate-600 text-white px-8 py-3 rounded-xl font-bold hover:from-slate-600 hover:to-slate-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-slate-700/30 transform active:scale-95">
                  {contact.action}
                </button>
              </div>
            ))}
